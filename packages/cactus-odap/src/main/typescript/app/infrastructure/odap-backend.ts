...
export interface IOdapDummyInfrastructureOptions {
 ...
 * possible.
 */
export class OdapDummyInfrastructure {
  public static readonly CLASS_NAME = "OdapDummyInfrastructure";
  ...
  public get className(): string {
    return OdapDummyInfrastructure.CLASS_NAME;
  }

  constructor(public readonly options: IOdapDummyInfrastructureOptions) {
