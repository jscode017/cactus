...
test(testCase, async (t: Test) => {
  ...
  }
  {
    ...
    t.throws(() => apiClient.sendClientRequestV1(odapClientRequest));
    odapClientRequest.rollBackForLock = false;
    odapClientRequest.rollBackForDelete = true;
    t.throws(() => apiClient.sendClientRequestV1(odapClientRequest));
    odapClientRequest.rollBackForDelete = false;
    odapClientRequest.rollBackForCreate = true;
    t.throws(() => apiClient.sendClientRequestV1(odapClientRequest));
  }
  t.end();
});
